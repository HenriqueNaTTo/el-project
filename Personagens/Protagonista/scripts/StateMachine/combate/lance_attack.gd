...
const ANIM_ATTACK_1 := "spear_attack1"
const ANIM_ATTACK_2 := "spear_attack2"
const ANIM_ATTACK_3 := "spear_attack3"

const TREE_ATTACK_1 := "parameters/lancaAtaque/conditions/attack1"
const TREE_ATTACK_2 := "parameters/lancaAtaque/conditions/attack2"
const TREE_ATTACK_3 := "parameters/lancaAtaque/conditions/attack3"

func _ready() -> void:
	max_combo = 3
	attack_speed = 3.0
	anim_tree_root_condition = "parameters/conditions/isLancaAtaque"
